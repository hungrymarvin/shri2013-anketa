var data = { 'tasks': [
    ...
    {
        'title': 'Вопрос 2',
        'text': '<p>Город, в котором вы живёте.',
    ...
    },
    {
        ...
        'input': '<p><input type="radio" name="q5" tabindex="5" value="1" id="a5_1"><label for="a5_1">&nbsp;начальный</label></p><p><input type="radio" name="q5" value="2" id="a5_2"><label for="a5_2">&nbsp;средний</label></p><p><input type="radio" name="q5" value="3" id="a5_3"><label for="a5_3">&nbsp;свободное владение</label></p>'
    },
    {
        'title': 'Вопрос 6',
        'text': '<p>Чего вы ожидаете от участия в Школе?</p>',
        'input': '<input type="text" tabindex="6" name="q6" id="q6">'
    },
    {
        'title': 'Вопрос 7',
        'text': '<p>Откуда вы о нас узнали?</p>',
        'input': '<input type="text" tabindex="7" name="q7" id="q7">'
    },
    {
        'title': 'Вопрос 8',
        'text': '<p>Сколько времени вы были бы готовы уделять стажировке или работе в Яндексе?</p>',
        'input': '<input type="text" tabindex="8" name="q8" id="q8">'
    },
    {
        'title': 'Вопрос 9',
    ...
    },
    {
        ...
        'input': '<textarea rows="3" tabindex="11" name="q11" id="q11"></textarea>'
    },
    {
        'title': 'Вопрос 12',
        ...
        'input': '<textarea rows="3" tabindex="12" name="q12" id="q12"></textarea>'
    },
    {
        'title': 'Вопрос 13',
        ...
        'input': '<input type="text" tabindex="13" name="q13" id="q13">'
    },
    {
        'title': 'Вопрос 14',
        ...
        'input': '<input type="text" tabindex="14" name="q14" id="q14">'
    },
    {
        'title': 'Вопрос 15',
        ...
        'input': '<input type="text" tabindex="15" name="q15" id="q15">'}
]};
